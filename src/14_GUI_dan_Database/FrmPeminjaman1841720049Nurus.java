...
import backend1841720049Nurus.Peminjaman1841720049Nurus;
import backend1841720049Nurus.Buku1841720049Nurus;
import java.util.ArrayList;
import javax.swing.table.DefaultTableModel;

public class FrmPeminjaman1841720049Nurus extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720049Nurus() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720049Nurus> list = new Peminjaman1841720049Nurus().getAll();
    ...
    public void cariAnggota(String keyword){
        Anggota1841720049Nurus anggota = new Anggota1841720049Nurus().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getmNama());
    }
    
    public void cariBuku(String keyword){
        Buku1841720049Nurus buku = new Buku1841720049Nurus().getById(Integer.parseInt(keyword));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720049Nurus pmj = new Peminjaman1841720049Nurus();
        pmj.setIdpeminjaman(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720049Nurus anggota = new Anggota1841720049Nurus().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720049Nurus buku = new Buku1841720049Nurus().getById(Integer.parseInt(txtIdBuku.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720049Nurus pmj = new Peminjaman1841720049Nurus().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720049Nurus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720049Nurus().setVisible(true);
            }
        });
    }
